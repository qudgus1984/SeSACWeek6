...
/*
 권한 : 반영이 조금 느릴 수 있음. 지웠다가 실행한다고 하더라도, 한 번 허용
 설정: 앱이 바로 안뜨는 경우도 있을 수 있음. 뜨시는 분들은 설정 쪽에서 다음에 묻기 설정
 */
...
class MapViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let center = CLLocationCoordinate2D(latitude: 33.809195, longitude: -117.918985)

        setRegionAndAnnotation(center: center)
    }
    
    func setRegionAndAnnotation(center: CLLocationCoordinate2D) {
        // 고척돔구장 : 37.498220, 126.867133
        // 에베레스트 : 27.988301, 86.924456
        //33.809195, -117.918985
